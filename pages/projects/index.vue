<template>
    <section
        ...
        <CommonTypingHeading text="My Projects" size="2xl" :cursor="true" :gradient="true" :speed="30"
            :startOnMount="true" class="mb-6" />

        <div v-if="pending">Loading projects...</div>
        <div v-else class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <ProjectCard v-for="p in projects" :key="p.id" :project="p" @preview="onPreview" />
        </div>
    </section>
